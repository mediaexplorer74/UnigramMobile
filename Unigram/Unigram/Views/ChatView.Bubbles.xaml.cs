...
namespace Unigram.Views
{
    public partial class ChatView
    {
        ...
        public void ViewVisibleMessages(bool intermediate)
        {
            ...
            {
                ViewModel.ProtoService.Send(new ViewMessages(chat.Id, /*ViewModel.ThreadId*/default, /*messages*/default, false));
            }
            ...
            if (content is Grid grid)
            {
                ...
                if (photo != null)
                {
                    ...
                    if (message.IsSaved())
                    {
                        ...
                        {
                            var chat = message.ProtoService.GetChat(fromChat.SenderChatId) as Chat;
                            if (chat != null)
                            {
                        ...
                        {
                            var chat = message.ProtoService.GetChat(fromChannel.ChatId) as Chat;
                            if (chat != null)
                            {
                                photo.Source = PlaceholderHelper.GetChat(ViewModel.ProtoService, chat, 30);
                            }
                ...
                if (action != null)
                {
                    ...
                    if (message.IsSaved())
                    {
                        if (message.ForwardInfo?.Origin is MessageForwardOriginMessageImport 
                            /*|| message.ForwardInfo?.Origin is MessageForwardOriginHiddenUser*/)
                        {
