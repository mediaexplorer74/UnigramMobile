...
namespace Unigram.Views.Popups
{
    public sealed partial class ThemePreviewPopup : ContentPopup
    {
        ...
        private async void Initialize(string path)
        {
            ...
            /*
            Message1.Mockup(new MessagePhoto(new Photo(false, null, new[] 
            { new PhotoSize("i", new File { Local = new LocalFile { Path = "ms-appx:///Assets/Mockup/theme_preview_image.jpg" } }, 500, 302, new int[0]) }), new FormattedText(), false), "Bring it on! I LIVE for this!", false, DateTime.Now.AddSeconds(-25), true, true);
