...
namespace Unigram.Views.Channels
{
    public sealed partial class ChannelCreateStep2Page : HostedPage, ISupergroupEditDelegate
    {
            ...
            else if (args.Phase == 1)
            {
                if (chat.Type is ChatTypeSupergroup super)
                {
                    ...
                    if (supergroup != null)
                    {
                        ...
                        subtitle.Text = MeUrlPrefixConverter.Convert(ViewModel.CacheService, 
                            supergroup.Id.ToString(), true);
                    }
                }
            }
        ...
        public void UpdateSupergroup(Chat chat, Supergroup group)
        {
            ...
            Subheader.Footer = group.Id.ToString().Length > 0 ? group.IsChannel ? Strings.Resources.ChannelPublicInfo : Strings.Resources.MegaPublicInfo : group.IsChannel ? Strings.Resources.ChannelPrivateInfo : Strings.Resources.MegaPrivateInfo;
            ...
            ViewModel.Username = group.Id.ToString();
            ViewModel.IsPublic = !string.IsNullOrEmpty(group.Id.ToString());
        }
        ...
        public void UpdateSupergroupFullInfo(Chat chat, Supergroup group, SupergroupFullInfo fullInfo)
        {
            ...
            if (fullInfo.InviteLink == null && string.IsNullOrEmpty(group.Id.ToString()))
            {
