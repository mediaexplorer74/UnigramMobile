    ...
    public sealed partial class SettingsPage : Page, ISettingsDelegate, IDisposable
    {
        ...
        private async void About_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (chat.Type is ChatTypePrivate privata)
            {
                ...
                var dialog = new EditYourAboutPopup(user.Bio.ToString());
        ...
        public void UpdateUser(Chat chat, User user, bool secret)
        {
            ...
            Username.Badge = string.IsNullOrEmpty(user.FirstName) 
                ? Strings.Resources.UsernameEmpty : $"{user.FirstName}";
        }

        public void UpdateUserFullInfo(Chat chat, User user, UserFullInfo fullInfo, 
            bool secret, bool accessToken)
        {
            Bio.Badge = string.IsNullOrEmpty(fullInfo.Bio.ToString())
                ? Strings.Resources.UserBioDetail.ToString() : fullInfo.Bio.ToString();
        }
