...
namespace Unigram.Views.Settings
{
    public sealed partial class SettingsStoragePage : HostedPage
    {
        ...
        private void OnContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
        {
            ...
            var chat = ViewModel.ProtoService.GetChat(statistics.ChatId) as Chat;
            //if (chat == null)
            //{
            //    return;
            //}
            ...
            if (args.Phase == 0)
            {
                ...
                title.Text = chat == null 
                    ? Strings.Additional.SettingsStorageOtherChats 
                    : ViewModel.ProtoService.GetTitle(chat);
            }
