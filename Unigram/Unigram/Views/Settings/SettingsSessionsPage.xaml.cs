...
{
    public sealed partial class SettingsSessionsPage : Page // HostedPage
    {
        public SettingsSessionsViewModel ViewModel
        {
            get
            {
                return DataContext as SettingsSessionsViewModel;
            }
        }
            ...
            ContainerContentChangingEventArgs args)
        {
            ...
            {
                var list = session.IsPasswordPending ? ViewModel.Items.FirstOrDefault() 
                    : ViewModel.Items.LastOrDefault();
                if (list == null)
                {
                    return;
                }
