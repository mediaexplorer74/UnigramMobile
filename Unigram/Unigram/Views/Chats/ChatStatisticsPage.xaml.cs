...
{
    public sealed partial class ChatStatisticsPage : Page//HostedPage, IChatDelegate
    {
        ...
        {
            InitializeComponent();
            DataContext = default;//TLContainer.Current.Resolve<ChatStatisticsViewModel, IChatDelegate>(this);
        ...
        private string ConvertPeriod(int startDate, int endDate)
        {
            ...
            return string.Format("{0} - {1}", 
                BindConvert.Current.ShortDate.Format(start), BindConvert.Current.ShortDate.Format(end));
        }
