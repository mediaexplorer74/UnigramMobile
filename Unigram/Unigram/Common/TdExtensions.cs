    ...
    public static class TdExtensions
    {
        ...
        public static bool IsAnimatedStickerDownloadCompleted(this MessageViewModel message)
        {
            ...
            switch (content)
            {
                ...
                //        ? sticker.Sticker.StickerValue.Local.IsDownloadingCompleted : false;
                //case MessageText text:
                //    return (text.WebPage?.Sticker is Sticker myStick 
                //        && (myStick.Type is StickerTypeAnimated 
                //        || myStick.Type is StickerTypeVideo)) 
                //        ? text.WebPage.Sticker.StickerValue.Local.IsDownloadingCompleted : false;
        ...
        public static File GetAnimatedSticker(this Message message)
        {
            switch (message.Content)
            {
                ...
                case MessageText text:
                    return (text.WebPage?.Sticker is Sticker myStick 
                        /*&& (myStick.Type is StickerTypeAnimated || myStick.Type is StickerTypeVideo)*/) 
                        ? text.WebPage?.Sticker?.StickerValue
                        : null;
                default:
                    return null;
            }
        ...
        public static bool CanPinMessages(this Supergroup supergroup)
        {
            ...
            return supergroup.Status is ChatMemberStatusCreator;//
               //|| supergroup.Status is ChatMemberStatusAdministrator administrator && administrator.CanPinMessages;
        }
        ...
        public static bool CanDeleteMessages(this Supergroup supergroup)
        {
            ...
            return supergroup.Status is ChatMemberStatusCreator 
                /*|| supergroup.Status is ChatMemberStatusAdministrator administrator 
                && administrator.CanDeleteMessages*/;
        }
        ...
        public static bool CanPinMessages(this BasicGroup basicGroup)
        {
            ...
            return basicGroup.Status is ChatMemberStatusCreator 
                /*|| basicGroup.Status is ChatMemberStatusAdministrator administrator 
                && administrator.CanPinMessages*/;
        }
        ...
        public static bool CanRestrictMembers(this Supergroup supergroup)
        {
            ...
            return supergroup.Status is ChatMemberStatusCreator 
                /*|| supergroup.Status is ChatMemberStatusAdministrator administrator 
                && administrator.CanRestrictMembers*/;
        }
        ...
        public static bool CanPromoteMembers(this Supergroup supergroup)
        {
            ...
            return supergroup.Status is ChatMemberStatusCreator 
                /*|| supergroup.Status is ChatMemberStatusAdministrator administrator 
                && administrator.CanPromoteMembers*/;
        }
