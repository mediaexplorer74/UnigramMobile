...
namespace Unigram.Common
{
    public static class Automation
    {
        ...
        public static string GetDescription(IProtoService cacheService, Message message)
        {
            ...
            if (!light && /*message.IsFirst &&*/ 
                !message.IsOutgoing && !message.IsChannelPost 
                /*&& (chat.Type is ChatTypeBasicGroup || chat.Type is ChatTypeSupergroup)*/)
            {
            ...
            {
                title = cacheService.GetTitle(/*chat*/default);
            }
            ...
            if (chat != null)
            {
                maxId = default;//chat.LastReadOutboxMessageId;
            }
