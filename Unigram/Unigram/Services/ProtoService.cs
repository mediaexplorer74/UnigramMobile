...
namespace Unigram.Services
{
    ...
    public class ProtoService : IProtoService, ClientResultHandler
    {
        ...
        private void Initialize(bool online = true)
        {
            ...
            _users[ 0] = new User( 0, "Jane",                   string.Empty, string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 1] = new User( 1, "Tyrion", "Lannister",    string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 2] = new User( 2, "Alena", "Shy",           string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 3] = new User( 3, "Heisenberg",             string.Empty, string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 4] = new User( 4, "Bender",                 string.Empty, string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 5] = new User( 5, "EVE",                    string.Empty, string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[16] = new User(16, "Nick",                   string.Empty, string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 7] = new User( 7, "Eileen", "Lockhard \uD83D\uDC99", string.Empty, string.Empty, new UserStatusOnline(int.MaxValue), ProfilePhoto("a5.png"), false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[11] = new User(11, "Thomas",                 string.Empty, string.Empty, string.Empty, null, ProfilePhoto("a3.png"), false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 9] = new User( 9, "Daenerys",               string.Empty, string.Empty, string.Empty, null, ProfilePhoto("a2.png"), false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[13] = new User(13, "Angela", "Merkel",       string.Empty, string.Empty, null, ProfilePhoto("a1.png"), false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[10] = new User(10, "Julian", "Assange",      string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[ 8] = new User( 8, "Pierre",                 string.Empty, string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[17] = new User(17, "Alexmitter",             string.Empty, string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);
            _users[18] = new User(18, "Jaina", "Moore",         string.Empty, string.Empty, null, null, false, false, false, false, string.Empty, true, false, new UserTypeRegular(), string.Empty);

            _secretChats[1] = new SecretChat(1, 7, new SecretChatStateReady(), false, 15, new byte[0], 75);

            _supergroups[0] = new Supergroup(0, string.Empty, 0, new ChatMemberStatusMember(), 0, false, false, false, true, true, false, string.Empty, false);
            _supergroups[1] = new Supergroup(1, string.Empty, 0, new ChatMemberStatusMember(), 0, false, false, false, true, false, false, string.Empty, false);
            ...
            _chats[ 0] = new Chat( 0, new ChatTypeSupergroup(0, true), null,     "Unigram News",     ChatPhoto("a0.png"), null,  lastMessage0,  long.MaxValue - 0,  true,  false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 1] = new Chat( 1, new ChatTypePrivate(0),          null,     "Jane",             ChatPhoto("a6.png"), null,  lastMessage1,  long.MaxValue - 1,  true,  false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 2] = new Chat( 2, new ChatTypePrivate(1),          null,     "Tyrion Lannister", null,                null,  lastMessage2,  long.MaxValue - 2,  false, false, false, false, false, false, false, false, 1, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 3] = new Chat( 3, new ChatTypePrivate(2),          null,     "Alena Shy",        ChatPhoto("a7.png"), null,  lastMessage3,  long.MaxValue - 3,  false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 4] = new Chat( 4, new ChatTypeSecret(0, 3),        null,     "Heisenberg",       ChatPhoto("a8.png"), null,  lastMessage4,  long.MaxValue - 4,  false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 5] = new Chat( 5, new ChatTypePrivate(4),          null,     "Bender",           ChatPhoto("a9.png"), null,  lastMessage5,  long.MaxValue - 5,  false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 6] = new Chat( 6, new ChatTypeSupergroup(1, true), null,     "World News Today", ChatPhoto("a10.png"), null, lastMessage6,  long.MaxValue - 6,  false, false, false, false, false, false, false, false, 1, 0, 0, 0, new ChatNotificationSettings(false, int.MaxValue, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 7] = new Chat( 7, new ChatTypePrivate(5),          null,     "EVE",              ChatPhoto("a11.png"), null, lastMessage7,  long.MaxValue - 7,  false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[ 8] = new Chat( 8, new ChatTypePrivate(16),         null,     "Nick",             null,                 null, lastMessage8,  long.MaxValue - 8,  false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[11] = new Chat(11, new ChatTypePrivate(16),         null,     "Kate Rodriguez",   ChatPhoto("a13.png"), null, lastMessage9,  long.MaxValue - 9,  false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[12] = new Chat(12, new ChatTypeSupergroup(3, false),null,     "Meme Factory",     ChatPhoto("a14.png"), null, lastMessage10, long.MaxValue - 10, false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[13] = new Chat(13, new ChatTypePrivate(18),         null,     "Jaina Moore",      null,                 null, lastMessage11, long.MaxValue - 11, false, false, false, false, false, false, false, false, 0, 0, 0, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);

            _chats[ 9] = new Chat( 9, new ChatTypeSupergroup(2, false), null,    "Weekend Plans", ChatPhoto("a4.png"),  null, null, 0, false, false, false, false, false, false, false, false, 0, 0, long.MaxValue, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
            _chats[10] = new Chat(10, new ChatTypeSecret(1, 7), null, "Eileen Lockhard \uD83D\uDC99", ChatPhoto("a5.png"),  null, null, 0, false, false, false, false, false, false, false, false, 0, 0, long.MaxValue, 0, new ChatNotificationSettings(false, 0, false, string.Empty, false, true, true, true, true, true), null, 0, 0, null, string.Empty);
#endif
