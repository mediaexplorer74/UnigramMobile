...
namespace Unigram.ViewModels
{
    public partial class DialogViewModel
    {
        ...
        public async void SendBotInlineResult(InlineQueryResult queryResult, long queryId)
        {
            ...
            var response = await ProtoService.SendAsync(
                new SendInlineQueryResultMessage(chat.Id, _threadId, /*reply*/default, 
                options, queryId, queryResult.GetId(), false));
        }
    }
    ...
    public class BotResultsCollection : IncrementalCollection<InlineQueryResult>
    {
        ...
        public string SwitchPmParameter => "aaa";//_results.SwitchPmParameter;
        public string SwitchPmText => "bbb";//_results.SwitchPmText;
