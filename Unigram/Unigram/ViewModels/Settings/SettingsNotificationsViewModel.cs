...
namespace Unigram.ViewModels.Settings
{
    ...
    public class SettingsNotificationsScope : TLViewModelBase
    {
        ...
        {
            await ProtoService.SendAsync(new SetScopeNotificationSettings(GetScope(), 
                new ScopeNotificationSettings(_alert ? 0 : int.MaxValue, 
                default, _preview, _disablePinnedMessage, 
                _disableMention,default,default,default,default)));
        }
