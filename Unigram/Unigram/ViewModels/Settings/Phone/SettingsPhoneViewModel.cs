...
namespace Unigram.ViewModels.Settings
{
    public class SettingsPhoneViewModel : TLViewModelBase
    {
        ...
        private async void SendExecute()
        {
            ...
            var response = await ProtoService.SendAsync(new ChangePhoneNumber(phoneNumber, 
                new PhoneNumberAuthenticationSettings(false, false, false, false, default,new string[0])));
