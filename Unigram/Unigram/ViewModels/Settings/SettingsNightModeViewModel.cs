...
namespace Unigram.ViewModels.Settings
{
    public class SettingsNightModeViewModel : TLViewModelBase
    {
        ...
        public async void UpdateTheme()
        {
            ...
            var theme = Settings.Appearance.GetCalculatedElementTheme();
            ...
            Aggregator.Publish(new UpdateSelectedBackground(true, 
                ProtoService.GetSelectedBackground(true)));
            Aggregator.Publish(new UpdateSelectedBackground(false, 
                ProtoService.GetSelectedBackground(false)));
        }
