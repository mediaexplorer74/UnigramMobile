...
namespace Unigram.ViewModels
{
    public class MessageViewModel
    {
        ...
        { get => _message.InteractionInfo; set => _message.InteractionInfo = value; }
        ...
        {
            get;// => _message.TtlExpiresIn;

            set;// => _message.TtlExpiresIn = value;
        }
        public int Ttl
        {
            get
            {
                return default;//_message.Ttl;
            }
        }

        public long ReplyToMessageId 
        {
            get;// => _message.ReplyToMessageId; 
            set;// => _message.ReplyToMessageId = value; 
        }
        public long ReplyInChatId
        {
            get
            {
                return default;//_message.ReplyInChatId;
            }
        }
        ...
        public bool ContainsUnreadMention 
        { 
            get => _message.ContainsUnreadMention; 
            set => _message.ContainsUnreadMention = value; 
        }
        ...
        public BaseObject GetSender()
        {
            ...
            {
                return default;//ProtoService.GetChat(chat.ChatId);
            }
        ...
        public Chat GetChat()
        {
            return default;//ProtoService.GetChat(_message.ChatId);
        }
        ...
        public bool IsShareable()
        {
            ...
            else if (message.SenderId is MessageSenderUser)
            {
                ...
                if (!message.IsOutgoing)
                {
                    ...
                    Chat chat = message.ProtoService.GetChat(message.ChatId) as  Chat;
                    if (chat != null && chat.Type is ChatTypeSupergroup super && !super.IsChannel)
                    {
                        ...
                        return supergroup != null && supergroup.Id.ToString().Length > 0
                            && !(message.Content is MessageContact) &&
                            !(message.Content is MessageLocation);
                    }
                }
            }
