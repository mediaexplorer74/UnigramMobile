...
#pragma warning restore CS4014
            ...
            if (chat.Id == 10)
            {
                Items.Add(_messageFactory.Create(this, new Message(0, 0, chat.Id, null, null, true,  false, false, false, false, false, false, TodayDate(14, 58), 0, null, 0, 0,  0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("Hey Eileen", new TextEntity[0]), null), null)));
                Items.Add(_messageFactory.Create(this, new Message(1, 0, chat.Id, null, null, true,  false, false, false, false, false, false, TodayDate(14, 59), 0, null, 0, 0,  0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("So, why is Telegram cool?", new TextEntity[0]), null), null)));
                ...
                Items.Add(_messageFactory.Create(this, new Message(3, 0, chat.Id, null, null, true,  false, false, false, false, false, false, TodayDate(14, 59), 0, null, 0, 0,  0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("😴", new TextEntity[0]), null), null)));
                Items.Add(_messageFactory.Create(this, new Message(4, 7, chat.Id, null, null, false, false, false, false, false, false, false, TodayDate(15, 00), 0, null, 0, 0,  0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("And it has secret chats, like this one, with end-to-end encryption!", new TextEntity[0]), null), null)));
                Items.Add(_messageFactory.Create(this, new Message(5, 0, chat.Id, null, null, true,  false, false, false, false, false, false, TodayDate(15, 00), 0, null, 0, 0,  0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("End encryption to what end??", new TextEntity[0]), null), null)));
            ...
            else
            {
                ...
                Items.Add(_messageFactory.Create(this, new Message(4, 11, chat.Id, null, null, false, false, false, false, false, false, false, TodayDate(15, 25), 0, null, 0, 0, 0, 0, string.Empty, 0, 0, null, new MessageSticker(new Sticker(0, 512, 512, "", false, false, null, null, new File(0, 0, 0, new LocalFile(System.IO.Path.Combine(Windows.ApplicationModel.Package.Current.InstalledLocation.Path, "Assets\\Mockup\\sticker0.webp"), true, true, false, true, 0, 0, 0), null))), null)));
                Items.Add(_messageFactory.Create(this, new Message(1, 9,  chat.Id, null, null, false, false, false, false, false, false, false, TodayDate(15, 26), 0, null, 0, 0, 0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("Are you sure it's safe here?", new TextEntity[0]), null), null)));
                Items.Add(_messageFactory.Create(this, new Message(2, 7,  chat.Id, null, null, true,  false, false, false, false, false, false, TodayDate(15, 27), 0, null, 0, 0, 0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("Yes, sure, don't worry.", new TextEntity[0]), null), null)));
                Items.Add(_messageFactory.Create(this, new Message(3, 13, chat.Id, null, null, false, false, false, false, false, false, false, TodayDate(15, 27), 0, null, 0, 0, 0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("Hallo alle zusammen! Is the NSA reading this? 😀", new TextEntity[0]), null), null)));
                ...
                Items.Add(_messageFactory.Create(this, new Message(5, 10, chat.Id, null, null, false, false, false, false, false, false, false, TodayDate(15, 29), 0, null, 0, 0, 0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("Sorry, I'll have to publish this conversation on the web.", new TextEntity[0]), null), null)));
                Items.Add(_messageFactory.Create(this, new Message(6, 10, chat.Id, null, null, false, false, false, false, false, false, false, TodayDate(15, 01), 0, null, 0, 0, 0, 0, string.Empty, 0, 0, null, new MessageChatDeleteMember(10), null)));
                Items.Add(_messageFactory.Create(this, new Message(7, 8,  chat.Id, null, null, false, false, false, false, false, false, false, TodayDate(15, 30), 0, null, 0, 0, 0, 0, string.Empty, 0, 0, null, new MessageText(new FormattedText("Wait, we could have made so much money on this!", new TextEntity[0]), null), null)));
            }
#endif
