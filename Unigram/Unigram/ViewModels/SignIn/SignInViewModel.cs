...
namespace Unigram.ViewModels.SignIn
{
    public class SignInViewModel : TLViewModelBase, IDelegable<ISignInDelegate>
    {
        ...
        private async void SendExecute()
        {
            ...
            //RnD
            SetAuthenticationPhoneNumber function = new SetAuthenticationPhoneNumber(
                phoneNumber, new PhoneNumberAuthenticationSettings(
                    false, false, false, false, default, new string[0]));
