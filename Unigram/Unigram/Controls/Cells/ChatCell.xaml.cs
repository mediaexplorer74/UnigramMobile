...
namespace Unigram.Controls.Cells
{
    ...
    public sealed partial class ChatCell : ToggleButton
    {
        ...
        public void UpdateMessage(IProtoService protoService, IChatListDelegate delegato, Message message)
        {
            ...
            UpdateChatTitle(/*chat*/default);
            UpdateChatPhoto(/*chat*/default);
            UpdateChatType(/*chat*/default);
            UpdateNotificationSettings(/*chat*/default);
            ...
            FromLabel.Text = UpdateFromLabel(/*chat*/default, message);
            BriefLabel.Text = UpdateBriefLabel(/*chat*/default, message, true, false);
            TimeLabel.Text = UpdateTimeLabel(message);
            StateIcon.Glyph = UpdateStateIcon(/*chat.LastReadOutboxMessageId*/default, /*chat*/default, 
                null, message, message.SendingState);
        }

        public async void UpdateChatList(IProtoService protoService, IChatListDelegate delegato, 
            ChatList chatList)
        {
            _protoService = protoService;
            _delegate = delegato;
        ...
        public void UpdateChatActions(Chat chat, IDictionary<MessageSender, ChatAction> actions)
        {
            ...
            {
                TypingLabel.Text = InputChatActionManager.GetTypingString(
                    chat, actions, _protoService.GetUser, /*_protoService.GetChat*/default, 
                    out ChatAction commonAction);
