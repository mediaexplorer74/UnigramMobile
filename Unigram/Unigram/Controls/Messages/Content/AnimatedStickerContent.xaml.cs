...
namespace Unigram.Controls.Messages.Content
{
    public sealed partial class AnimatedStickerContent : HyperlinkButton, IContentWithFile
    {
        ...
        public bool IsValid(MessageContent content, bool primary)
        {
            ...
            {
                return default;//(sticker.Sticker.Type is StickerTypeAnimated 
                    //|| sticker.Sticker.Type is StickerTypeVideo);
            }
            else if (content is MessageText text && text.WebPage != null && !primary)
            {
                return default;//text.WebPage.Sticker != null
                    //&& (text.WebPage.Sticker.Type is StickerTypeAnimated || text.WebPage.Sticker.Type is StickerTypeVideo);
            }
