        ...
        private async void OnClick(object sender, RoutedEventArgs e)
        {
            if (ClickMode == ClickMode.Press)
            {
                ...
                bool restricted = default;/*
                    await ViewModel.VerifyRightsAsync(chat, x => x.CanSendMediaMessages, 
                    Strings.Resources.GlobalAttachMediaRestricted, 
                    Strings.Resources.AttachMediaRestrictedForever, 
                    Strings.Resources.AttachMediaRestricted);*/
                if (restricted)
                {
                    return;
                }
        ...
        public async void ToggleRecording()
        {
            ...
            else
            {
                ...
                bool restricted = default;
                    /*await ViewModel.VerifyRightsAsync(chat, x => x.CanSendMediaMessages, 
                     * Strings.Resources.GlobalAttachMediaRestricted, 
                     * Strings.Resources.AttachMediaRestrictedForever, Strings.Resources.AttachMediaRestricted);*/
                if (restricted)
                {
                    return;
                }
